...
local music = audio.loadStream("theme.mp3", musicOptions)
audio.play(music)
...
if fh then
    -- read all contents of file into a int
...
if x==3 then
	composer.gotoScene( "LevelsS1", "fade", 500 )
	elseif x==2 then
	composer.gotoScene( "LevelS", "fade", 500 )
	else 
	composer.gotoScene( "LevelsS2", "fade", 500 )
end
...
local background = display.newImageRect("background.jpg", display.contentWidth, display.actualContentHeight)
