...
local background = display.newImageRect("Restart.png", display.contentWidth, display.actualContentHeight)
...
local scoreText = display.newText( x, 150, 150, native.systemFont, 16 )
	
	-- create a widget button (which will loads level1.lua on release)
	playBtn = widget.newButton{
		defaultFile = "Playagain.png",
		overFile = "Playagain2.png",
		width=154, height=40,
